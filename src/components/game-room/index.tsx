...
export default function GameRoom() {
  ...
  return (
    <form
      ...
      className="flex flex-col items-center justify-start gap-5 w-full h-full p-10 md:w-[40rem] md:mx-auto"
    >
      ...
      <p className="text-gray-600 text-center">
        Welcome to <span className="font-bold text-blue-400">The Social Bubble</span>, where every action has a social consequence. Gain likes and comments to increase your social standing, and play by the social rules to avoid the dreaded dislike. 
      </p>
      ...
      <p className="text-gray-600 text-center mb-5">
        If you suspect someone is a Troll, downvote their posts to reduce their social score to zero and block them from the game. Alternatively - flag them: if enough users flag a Troll, they'll be removed from the game. But be careful - you can flag (and block) innocent users too!
      </p>
      <p className="text-gray-600 text-center mb-5">
